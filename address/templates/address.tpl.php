...
<div class="address" itemscope itemtype="http://schema.org/Organization" itemref="mOrga">
  ...
  <?php if (empty($options['hide_sitename'])) : ?><p class="mtn"><strong itemprop="name"><?php print $name; ?></strong></p><?php endif; ?>
  <?php if (empty($options['hide_address'])): ?>
    <?php if (!empty($street_line_1) || !empty($street_line_2) || !empty($postale_code) || !empty($locality)) : ?>
      <p itemprop="address" itemscope itemtype="http://schema.org/PostalAddress"<?php if (empty($options['hide_sitename'])) : ?> class="mtn"<?php endif; ?>><span itemprop="streetAddress"><?php print $street_line_1; ?>
  ...
  <?php if (empty($options['hide_phone1']) && isset($phone)) : ?>
    <p class="mtn"><span class="a11y"><?php print t('Phone'); ?>&nbsp;:</span> <a href="tel:<?php print $phone_link; ?>" itemprop="telephone"><?php print $phone; ?></a></p>
  <?php endif; ?>
  <?php if (empty($options['hide_email'])) : ?>
  <p class="mtn"><span class="a11y"><?php print t('Email'); ?>&nbsp;:</span> <a itemprop="email" href="mailto:<?php print $email; ?>"><?php print $email; ?></a></p>
  <?php endif; ?>
  <?php if (isset($fax)) : ?>
