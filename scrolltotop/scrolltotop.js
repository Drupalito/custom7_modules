...
(function ($, window, Drupal) {
  Drupal.behaviors.scrolltotop = {
    attach: function (context, settings) {
      $('body').append('<a href="#" id="scrollToTop" class="scrollToTop scroll"><span aria-hidden="true" class="fa ' + settings.scrolltotop.icon + '"></span><span class="a11y">' + settings.scrolltotop.label + '</span></a>');
